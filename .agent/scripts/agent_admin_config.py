...
AGENTCTL_SH = REPO_ROOT / ".scripts" / "agentctl.sh"
AGENT_ADMIN_SH = REPO_ROOT / ".scripts" / "agent-admin.sh"
SEND_AND_VERIFY_SH = REPO_ROOT / ".scripts" / "send-and-verify.sh"
HARNESS_PROFILE_ROOT = REPO_ROOT / ".agents" / "skills" / "gstack-harness" / "assets" / "profiles"
