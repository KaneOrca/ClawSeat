...
python3 scan_environment.py --output "${CLAWSEAT_REAL_HOME:-$HOME}/.agents/memory/"   # → machine/ 5 文件
```
...
python3 scan_project.py --project clawseat --repo "$CLAWSEAT_ROOT" --depth shallow --commit
```
