...
Remember: `peer not in dispatch chain`; planner does not directly dispatch
peers and must keep peer work in the peer-deliveries contract instead of the
canonical seat chain.
