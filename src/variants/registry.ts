...
export const variantRegistry: Record<VariantType, VariantViews> = {
  v2: { home: V2Home, challengeDetail: V2ChallengeDetail, watch: V2Watch, hall: HallViewV2 },
  v3: { home: V3Home, challengeDetail: V3ChallengeDetail, watch: V3Watch, hall: HallViewV3 },
};
