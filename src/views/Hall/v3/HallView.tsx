  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .hall-v3-row-active {
          animation: hall-v3-active-pulse 0.95s ease-in-out infinite;
        }
        .hall-v3-row-active.hall-v3-row-zen {
          animation: none;
        }
        @keyframes hall-v3-active-pulse {
          0%, 100% {
            opacity: 0.82;
            text-shadow: 0 0 0 rgba(70, 214, 255, 0);
          }
          50% {
            opacity: 1;
            text-shadow: 0 0 14px rgba(70, 214, 255, 0.5);
          }
        }
      `}</style>
    </div>
