...
| external practice reference files | 已移除；ClawSeat seat 方法论回到本仓 seat/protocol 文档 |
...
| 外部 practice reference 文件 | 已删；不作为 ClawSeat runtime / catalog / seat 上下文 |
