    ...
    out = _run(
        {
            ...
            "CLAUDE_CODE_OAUTH_TOKEN": "sk-ant-oat01-FAKE_TOKEN_FOR_TEST",
...
""",
    ...
    assert "TOKEN=sk-ant-oat01-FAKE_TOKEN_FOR_TEST" in out
    ...
    out = _run(
        {
            ...
            "CLAUDE_CODE_OAUTH_TOKEN": "sk-ant-oat01-STALE_TOKEN",
        },
        """
snap=$(capture_oauth_host_env)
