...
MEMORY_PROTOCOL_HINT = (
    ...
    "this script:\n"
    "\n"
    "  1. If this is a first install and the KB is empty, seed it once:\n"
    ...
    "\n"
    "  2. Start the memory seat (once per install, Phase 1):\n"
    ...
    "\n"
    "  3. Query the memory knowledge base for the agent list (Phase 2):\n"
    ...
    "\n"
    "  4. Re-run install_koder_overlay.py with --agent <NAME>.\n"
    "\n"
