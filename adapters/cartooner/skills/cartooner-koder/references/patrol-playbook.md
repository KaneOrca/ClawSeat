...
- `{CLAWSEAT_ROOT}/.agents/skills/gstack-harness/scripts/render_console.py`
- `{CLAWSEAT_ROOT}/.agents/skills/gstack-harness/scripts/patrol_loop.py`
- `{CLAWSEAT_ROOT}/.agents/skills/gstack-harness/scripts/verify_handoff.py`
- `{CLAWSEAT_ROOT}/adapters/cartooner/scripts/check-cartooner-status.sh`

For the Cartooner consumer project,
`{CLAWSEAT_ROOT}/adapters/cartooner/scripts/check-cartooner-status.sh`
is the preferred patrol entrypoint. The lower-level fallback is:

- `{CLAWSEAT_ROOT}/.scripts/check-engineer-status.sh`
